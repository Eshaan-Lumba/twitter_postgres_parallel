...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/Eshaan-Lumba/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/Eshaan-Lumba/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/Eshaan-Lumba/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/Eshaan-Lumba/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/Eshaan-Lumba/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/Eshaan-Lumba/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        | 500.155s                  | 71.41s                    | 
| `pg_normalized_batch`  | 175.560s                  | 14.99s                    | 
| `pg_denormalized`      | 17.569s                   | 4.33s                     | 
